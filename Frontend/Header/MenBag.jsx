    ...
    const fetchProducts = async () => {
      try {
        ...
        const filteredData = response.data.response.filter(product =>
          product.Categories.includes("Men") && product.Categories.includes("Bags")
        );
                ...
                {filteredData.map(record => (
                  <div className="box" key={record.ProductId}>
                    ...
                    <div className="informations">
                      ...
                      {/* Remove the following line if 'price' is not a property of 'record' */}
